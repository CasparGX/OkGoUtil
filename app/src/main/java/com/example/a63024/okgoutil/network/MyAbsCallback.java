...
import com.example.a63024.okgoutil.network.JsonCallback;
import com.example.a63024.okgoutil.network.LzyResponse;
import com.google.gson.Gson;
import com.google.gson.reflect.TypeToken;
import com.lzy.okgo.cache.CacheMode;
import com.lzy.okgo.request.BaseRequest;
import com.lzy.okgo.utils.UrlApi;
 ...
 */
public abstract class MyAbsCallback<T> extends JsonCallback<T> {
    private App app;
    private Activity mActivity;
    public MyAbsCallback(App app, Activity activity, String secret) {
        super(secret);
        this.app = app;
    ...
    public void onSuccess(T t, Call call, Response response){
        try {
            ...
            String obj = UrlApi.decryptResult((String) result.data, app.secret);
            Gson gson = new Gson();
            T convertResult = gson.fromJson(obj, new TypeToken<T>() {}.getType());
            onSucceed(convertResult, call, response);
    ...
    public abstract void onSucceed(T t, Call call, Response response);
